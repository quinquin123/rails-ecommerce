...
class Api::V1::OrdersController < Api::V1::BaseController
  ...
  def create
    ...
    ActiveRecord::Base.transaction do
      ...
      render json: { 
        error: "Order state error: #{e.message}" 
      }, status: :unprocessable_entity
    end
  end
  ...
  def retry_payment
    ...
    unless @order.can_be_retried? && @order.may_retry_payment?
      return render json: { 
        error: 'This order cannot be retried' 
      }, status: :unprocessable_entity
    end
    ...
    begin
      ...
      render json: { 
        error: 'Unable to retry payment at this time' 
      }, status: :unprocessable_entity
    end
  end
  ...
  def refund
    ...
    begin
      ...
      render json: { 
        error: 'Unable to refund order at this time' 
      }, status: :unprocessable_entity
    end
  end
